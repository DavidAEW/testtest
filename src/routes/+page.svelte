<!-- Log in page -->
<div class="container h-full mx-auto flex justify-center items-center space-y-16 bg-background-50 text-text-300">
    <main class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        <form action="login" method="post" class="space-y-6">
            ...
            <button type="submit" class="w-full bg-primary-300 hover:bg-primary-350 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                Log in
            </button>
        </form>
        ...
        <div class="text-center mt-8">
            <a href="/Register" class="inline-block px-6 py-2 text-sm font-semibold text-center bg-primary-60 rounded-full text-primary-350 hover:bg-primary-70 focus:outline-none focus:ring-2 focus:ring-primary-300 focus:ring-opacity-50">
                Register
            </a>
        </div>
    </main>
